...
#       EXTRA_ASSIGN_COURSE        :: 额外需要安排的课程 指的是学考课 deprecated，已经没有此功能
#       BIND_CLASSES               :: 对开课程
...
COURSE_TOTAL = {
    '1班': {'语': 8, '数': 5, '英': 5, '物': 4, '化': 5, '政': 5, '体': 3, '音-美': 1, '班': 1},
    '2班': {'语': 8, '数': 8, '英': 3, '物': 3, '生': 3, '政': 3, '体': 4, '音-美': 4, '班': 4},
    '3班': {'语': 6, '数': 3, '英': 2, '物': 3, '化': 4, '政': 2, '体': 3, '音-美': 1, '班': 1},
    ...
    '10班': {'语': 5, '数': 6, '英': 5, '物': 2, '历': 4, '政': 4, '体': 3, '音-美': 1, '班': 1}
}

COURSE_LINKED_HOURS = {
    '1班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '2班': {'语': 2, '数': 2, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '3班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '4班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '5班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '6班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '7班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '8班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '9班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0},
    '10班': {'语': 2, '数': 1, '英': 1, '物': 1, '化': 1, '生': 1, '历': 1, '政': 1, '地': 1, '体': 0, '音-美': 0, '班': 0}
}
COURSE_MORNING_TOTAL = {
    ...
    '10班': {'语': 5, '数': 6, '英': 5, '物': 4, '化': 4, '生': 4, '历': 4, '政': 4, '地': 4, '体': 3, '音-美': 1, '班': 1}
}
TEACHER_HEAD_TAIL_NUM = {}
...
CLASSES_COURSE_TEACHER = {
    ...
    '10班': {'语': '吉茹颖', '数': '曹宇', '英': '路平', '历': '黄艳', '政': '刘婕', '音-美': '王祎', '班': '路平', '体': '体-2', '物': '王碧雪'}
}
CONFLICT_TEACHERS = {'毕姗-杨青': [{'week': 1, 'section': 1}, {'week': 2, 'section': 1}, {'week': 3, 'section': 1},
                               {'week': 4, 'section': 1},
                               {'week': 5, 'section': 1}, {'week': 6, 'section': 1}],
                     '于安琪-何映': [{'week': 1, 'section': 1}, {'week': 2, 'section': 1}, {'week': 3, 'section': 1},
                                {'week': 4, 'section': 1},
                                {'week': 5, 'section': 1}, {'week': 6, 'section': 1}]}
...
BIND_CLASSES = {'1班-化': {'class': '2班', 'subject': '生'}, '10班-政': {'class': '7班', 'subject': '地'}}
FLOW_CLASS_TIME = [
    {'week': 2, 'section': 5},
    {'week': 4, 'section': 5},
    {'week': 5, 'section': 5},
...
PART_SCHEDULE = [
    # 手排课-demo
    {'week': 2, 'section': 6, 'class': '10班', 'course': '体'},
    {'week': 3, 'section': 5, 'class': '1班', 'course': '体'},
]
LINK_COURSE_TIMES = [
    {'week': 1, 'section': 1},
    # {'week': 1, 'section': 2},
...
################################################################ 后期增加的变量 by Mayuan ###############################################################
# 大课间前后的课是否算是联排
LINKED_COURSE_FLAG = 0
# 大课间的位置在哪节课之后，索引从1开始，0代表没有大课间
CLASS_REST_POS = [2, 6]
################################################################################################################################
